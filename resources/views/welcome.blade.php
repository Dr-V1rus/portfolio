        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-12">
                    ...
                    <a href="#skills" class="text-gray-600 hover:text-gray-900 transition text-sm font-medium">Skills</a>
                    <a href="#about" class="text-gray-600 hover:text-gray-900 transition text-sm font-medium">About</a>
                    <a href="#contact" class="text-gray-600 hover:text-gray-900 transition text-sm font-medium">Contact</a>
                </div>
                <a href="#contact" class="bg-[#785555] text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-[#634444] transition">
                    Hire Me
                </a>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row items-center gap-12">
                ...
                <div class="flex-1 text-center md:text-left">
                    <span class="text-[#785555] font-semibold text-sm tracking-wider uppercase mb-4 block">FullStack Developer</span>
                    ...
                    <div class="flex flex-wrap items-center gap-4 justify-center md:justify-start">
                        <a href="#work" class="bg-[#785555] text-white px-8 py-4 rounded-xl font-medium hover:bg-[#634444] transition shadow-lg">
                            View My Work
                        </a>
                        <a href="https://wa.me/2349016308686?text=Hi%20Precious,%20I%20saw%20your%20portfolio" 
                           target="_blank"
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition">
                    ...
                    <div class="p-8">
                        ...
                        <p class="text-gray-600 mb-4">Complete Laravel application with authentication, database design, and responsive UI. My final defence project.</p>
                    </div>
                </div>
    ...
    <section id="skills" class="py-20">
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto">
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">PHP</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">Laravel</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">JavaScript</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">MySQL</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">Tailwind CSS</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">HTML5</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">CSS3</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">Git</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">Linux Basics</div>
                <div class="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium shadow-sm">REST APIs</div>
            </div>
        </div>
    </section>
    ...
    <section id="about" class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <span class="text-[#785555] font-semibold text-sm tracking-wider uppercase mb-4 block">About Me</span>
                    <h2 class="text-4xl font-bold mb-6">FullStack Developer</h2>
                    <p class="text-gray-600 text-lg leading-relaxed mb-6">
                        I'm Precious, a recent fullstack development graduate with a passion for building web applications. 
                        I started with the LAMP stack and expanded into Laravel and modern JavaScript.
                    </p>
                    <p class="text-gray-600 text-lg leading-relaxed mb-6">
                        My final defence project was a complete Laravel application that demonstrated my ability to handle 
                        authentication, database design, and responsive frontend development.
                    </p>
                    <p class="text-gray-600 text-lg leading-relaxed mb-8">
                        I'm now seeking an internship where I can contribute to real projects while learning from experienced developers.
                    </p>
                        ...
                        <div class="bg-white rounded-3xl p-8">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start gap-4">
                                    <div class="w-12 h-12 bg-[#785555]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm mt-1">Final defence: Complete Laravel application with authentication and database</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-12">
                    <span class="text-[#785555] font-semibold text-sm tracking-wider uppercase mb-4 block">Get In Touch</span>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-3">
                            <a href="https://github.com/Dr-V1rus" class="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center text-gray-600 hover:bg-[#785555] hover:text-white transition">
